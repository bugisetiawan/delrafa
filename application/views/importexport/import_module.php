        ...
        <div class="kt-portlet kt-portlet--mobile">            
                    ...
                    <tbody>                                 
                        <?php $error=0; $no=0; foreach($sheet AS $info): ?>
                            ...
                            <tr>
                                ...
                                <td class="text-dark"><?php echo $info[0]; ?></td>
                                <td class="text-dark"><?php echo $info[1]; ?></td>
                                <td class="text-center text-dark"><?php echo $info[2]; ?></td>
                                <td class="text-center text-dark"><?php echo $info[3]; ?></td>
                                <td class="text-center text-dark"><?php echo $info[4]; ?></td>
                            </tr>
                            <?php endif; ?>
                        <?php $no++; endforeach; ?>
                    </tbody>
            ...
            <div class="kt-portlet__foot">
                <div class="kt-form__actions">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo site_url('dashboard'); ?>" class="btn btn-danger btn-brand btn-elevate-hover btn-square form-control"><i class="fa fa-times"></i>BATAL</a>
                        </div>
                        <div class="col-md-6">                                
