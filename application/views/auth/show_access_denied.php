...
<html lang="en">
	...
	<head>
		...
		<!--end::Base Path -->
		<meta charset="utf-8" />
		<title>TRUST System | Denied</title>
		...
		<link href="./assets/css/demo1/pages/general/error/error-5.css" rel="stylesheet" type="text/css" />
			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid  kt-error-v5" style="background-image: url(./assets/media//error/bg5.jpg);">
				<div class="kt-error_container">
					...
					<p class="kt-error_description kt-font-dark">
                        Silahkan Menghubungi admin jika anda memiliki kendala, terima kasih.  <br>
						Kembali Ke 
						<?php if($this->session->userdata('role_id') != 5): ?>
							<a href="<?php echo base_url('dashboard'); ?>" class="text-success"><b>HALAMAN UTAMA</b></a>
						<?php else: ?>
							<a href="<?php echo base_url('pos'); ?>" class="text-success"><b>HALAMAN UTAMA</b></a>
						<?php endif; ?>
					</p>
				</div>
			</div>
