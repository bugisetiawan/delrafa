					...
					<div class="form-group row">
						<div class="col-md-5">
							<div class="row">
								...
								<div class="col-md-8">												
									<?php 
										$data = array('type' => 'text', 'class' => 'form-control', 'id' => 'date', 'name' => 'date',  'value' => date('d-m-Y', strtotime($sales_return['date'])), 'placeholder' => 'Silahkan isikan tanggal retur pembelian', 'required' => 'true'); 
							...
							<div class="row">
								...
								<div class="col-md-9">
									<select class="form-control" name="method" id="method">
										<option value="1" <?php if($sales_return['method'] == 1) { echo "selected"; } ?>>TIDAK POTONG PENJUALAN</option>
										<option value="2" <?php if($sales_return['method'] == 2) { echo "selected"; } ?>>POTONG PENJUALAN</option>
									</select>
								</div>
							</div>
						</div>
					...
					<div class="form-group row">
						<div class="col-md-5">
							<div class="row">
								...
								<div class="col-md-8">                 
									<input type="hidden" id="customer_code_update" value="<?php echo $sales_return['customer_code']; ?>">                               
							...
							<div class="row">
								...
								<div class="col-md-2">
									<select class="form-control" name="ppn" id="ppn">
										<option value="0" <?php if($sales_return['ppn'] == 0) { echo "selected"; } ?>>NON</option>
										<option value="1" <?php if($sales_return['ppn'] == 1) { echo "selected"; } ?>>PPN</option>
									</select>
								</div>
							</div>
						</div>
						...
						<div class="col-md-12">
							<table class="table table-sm table-checkable" id="product_table">
								...
								<tbody data-repeater-list="product">
									...
									<?php foreach($sales_return_detail AS $info): ?>
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="form-group row choose_invoice">
								<label class="col-md-3 col-form-label text-dark">NO. PENJUALAN</label>
								<div class="col-md-9">
									<input type="hidden" id="sales_invoice_id_update" value="<?php echo $sales_return['sales_invoice_id']; ?>">
									<select class="form-control" name="sales_invoice_id" id="sales_invoice_id">
										<option value="">- PILIH PENJUALAN -</option>
									</select>
									<small class="text-dark">Hanya Penjualan KREDIT dan BELUM LUNAS yang dapat dipotong</small>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-md-9">
									<?php
										$data = array('type' => 'text', 'class' => 'form-control text-right', 'id' => 'total_return', 'name' => 'total_return',  'value' => $sales_return['total_return'], 'required' => 'true', 'readonly' => 'true'); 
										echo form_input($data);                                             
