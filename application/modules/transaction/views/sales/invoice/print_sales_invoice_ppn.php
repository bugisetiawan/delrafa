            ...
            <table style="width:100%;" id="product_table" border="0">
                ...
                <tbody>
                    <?php for($j=0;$j<=11;$j++): ?>
                        ...
                        ?>
                        <td class="text-right"><?php echo $sales_invoice_detail[$product]['qty']*$product_unit['weight']; ?></td>
                        ...
                        <?php 
                            ...
                            {
                                $dpp = ($sales_invoice_detail[$product]['price'] / 1.11)*$sales_invoice_detail[$product]['qty'];
                    ...
                    <tr>
                        <td colspan="5" class="text-right">DPP</td>
                        <td class="text-right"><?php echo number_format($total_dpp, 2, '.', '.'); ?></td>
                    </tr>
                    <tr>
                        <td colspan="5" class="text-right">PPN</td>
                        <td class="text-right"><?php echo number_format($total_ppn, 2, '.', '.'); ?></td>
                    </tr>
                    <tr>
                        ...
                        <td class="text-right" style="border-top: 1px solid black;"><?php echo $total_weight; ?></td>    
                        <td colspan="2"  style="border-top: 1px solid black;" class="text-right">GRANDTOTAL</td>
                        <td style="border-top: 1px solid black;" class="text-right"><?php echo number_format($sales_invoice['grandtotal']-$sales_invoice['down_payment'],0,".",","); ?></td>
                    </tr>                    
                </tbody>
            </table>
        <?php endfor; ?>
