...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Surat Jalan | <?php echo $sales_invoice['invoice']; ?></title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">				
                                    <table style="width:100%;">
                                        <thead>
                                            <tr>
                                                <th colspan="3" class="text-right">SURAT JALAN | NO. TRANSAKSI: <?php echo $sales_invoice['invoice']; ?></th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
                            ...
                            <table style="width:100%;" id="product_table" >
                                ...
                                <tbody>
                                    ...
                                    <tr style="border-top: 1px solid black; border-bottom: 1px solid black;">
                                        <td colspan="4">Jumlah Koli : _________________</td>
                                    </tr>                                    
                                </tbody>
                            </table>
                            <br>
