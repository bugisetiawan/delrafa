                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">                           
                            ...
                            <a href="<?php echo base_url('sales/order'); ?>" class="btn btn-warning btn-elevate btn-icon-sm">
                                <i class="fa fa-cube"></i>
                                Pemesanan Penjualan
                            </a>
                            <a href="<?php echo base_url('sales/order/taking/add'); ?>" class="btn btn-success btn-elevate btn-icon-sm">
