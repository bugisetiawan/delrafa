        ...
        <?php echo form_open_multipart('', ['class' => 'repeater', 'autocomplete'=>'off']); ?>
            ...
            <div class="kt-portlet">                    
                ...
                <div class="kt-portlet__body">
                    <input type="hidden" name="sales_order_id" value=<?php echo encrypt_custom($sales_order['id']); ?>>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                <?php 
                                    $data = array('type' => 'text', 'class' => 'form-control', 'id' => 'date', 'name' => 'date',  'value' => date('d-m-Y', strtotime($sales_order['date'])), 'placeholder' => 'Silahkan isi tanggal pemesanan penjualan', 'required' => 'true'); 
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="hidden" id="customer_code_update" value="<?php echo $sales_order['customer_code']; ?>">
                        ...
                        <div class="col-md-6">                                
                            <div class="form-group row">                                
                                ...
                                <div class="col-md-9">
                                    <input type="hidden" id="sales_code_update" value="<?php echo $sales_order['sales_code']; ?>">
                            ...
                            <div class="form-group row">                                                                                 
                                ...
                                <div class="col-md-9">
                                    <input type="hidden" id="taking_method_update" value="<?php echo $sales_order['taking_method']; ?>">
                                    <select class="form-control" name="taking" id="taking">                                        
                            ...
                            <div class="form-group row" id="delivery">
                                ...
                                <div class="col-md-9">                                        
                                    <?php 
                                        $data = array('class' => 'form-control', 'rows' => 3, 'id' => 'delivery_address', 'name' => 'delivery_address',  'placeholder' => 'Silahkan isi alamat pengiriman...', 'value' => $sales_order['delivery_address']);
            ...
            <div class="kt-portlet">
                <div class="kt-portlet__head">
                    <div class="kt-portlet__head-label">
                        <h3 class="kt-portlet__head-title">
                            Daftar Produk
                            <small class="kt-font-primary" id="add_product" data-repeater-create>*<b>ENTER</b> (ketika didalam form daftar produk)/<b>Klik Disini</b> untuk menambah baris produk</small>
                        </h3>                                            
                    </div>						
                </div>
                <div class="kt-portlet__body">
                                ...
                                <tbody data-repeater-list="product">
                                    <tr data-repeater-item style="text-align:center; display:none;">
                                        <td>
                                            <div class="typeahead">
                                            <?php  
                                                $data = array('type' => 'text', 'class' => 'form-control product_input', 'placeholder' => 'Ketik Kode/Nama Produk...'); 
                                                echo form_input($data);
                                            ?>
                                            </div>
                                        </td>     
                                        ...
                                        <td>
                                            <select class="form-control unit" name="unit_id"></select>
                                        </td>
                                        <td>
                                            <?php 
                                    ...
                                    <?php foreach($sales_order_detail AS $info): ?>
                                    <tr data-repeater-item style="text-align:center;">
                                        <?php 
                                            $data = array('type' => 'hidden', 'name' => 'sales_order_detail_id', 'value' => $info['id']); 
                                            echo form_input($data);
                                        ?>
                                        <td>
                                            <div class="typeahead">
                                            <?php  
                                                $data = array('type' => 'text', 'class' => 'form-control product_input', 'placeholder' => 'Ketik Kode/Nama Produk...', 'value' => $info['name_p'], 'required' => 'true'); 
                                                echo form_input($data);
                                            ?>
                                            </div>
                                        </td>     
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <?php
                                        $data = array('type' => 'text', 'class' => 'form-control text-right', 'id' => 'total_product', 'name' => 'total_product',  'value' => number_format($sales_order['total_product'],0,'.',','), 'required' => 'true', 'readonly' => 'true'); 
                                        echo form_input($data);                                             
                                ...
                                <div class="col-md-3">
                                    <?php
                                        $data = array('type' => 'text', 'class' => 'form-control text-right', 'id' => 'total_qty', 'name' => 'total_qty',  'value' => number_format($sales_order['total_qty'],0,'.',','), 'required' => 'true', 'readonly' => 'true'); 
                                        echo form_input($data);                                             
                        ...
                        <div class="col-md-6">                                        
                            <div class="form-group row">
                                ...
                                <div class="col-md-8" id="discount_percent">
                                    <?php 
                                        $data = array('type' => 'text', 'class' => 'form-control text-right', 'name' => 'discount_p', 'id' => 'discount_p', 'placeholder' => 'Diskon (%)', 'value' => $sales_order['discount_p'], 'required' => 'true'); 
                                        echo form_input($data);                                             
                                        echo form_error('discount_p', '<p class="text-danger">', '</p>');                                            
                                    ?>
                                    <small class="text-dark">*Diskon Persen (%)</small>
                                </div>
                                <div class="col-md-8" id="discount_amount">
                                    <?php 
                                        $data = array('type' => 'text',  'class' => 'form-control text-right', 'name' => 'discount_rp', 'id' => 'discount_rp', 'placeholder' => 'Diskon (Rupiah)', 'value' => number_format($sales_order['discount_rp'],0,'.',','), 'required' => 'true'); 
                                        echo form_input($data);                                             
                                        echo form_error('discount_rp', '<p class="text-danger">', '</p>');
                                    ?>
                                    <small class="text-dark">*Diskon Rupiah (Rp)</small>
                                </div>
                            </div>                                       
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <?php
                                        $data = array('type' => 'text', 'class' => 'form-control text-right', 'id' => 'grandtotal', 'name' => 'grandtotal',  'value' => number_format($sales_order['grandtotal'],0,'.',','), 'required' => 'true', 'readonly' => 'true'); 
                                        echo form_input($data);                                             
                ...
                <div class="kt-portlet__foot">
                    <div class="kt-form__actions">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <button type="submit" id="btn_save" class="btn btn-success btn-brand btn-elevate-hover btn-square form-control"><i class="fa fa-save"></i> PERBARUI</button>
                            </div>
                        </div>
                    </div>
                </div>
