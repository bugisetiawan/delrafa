                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a href="<?php echo site_url('payment/receivable/create'); ?>" class="btn btn-square btn-success btn-elevate btn-elevate-air">
                                <i class="la la-plus"></i>
                                <span class="d-none d-sm-inline">Pembayaran Penjualan Baru</span>
                            </a>
                        </div>
                    </div>
                </div>
