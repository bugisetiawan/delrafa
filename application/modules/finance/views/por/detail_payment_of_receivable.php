            ...
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title">
                        Informasi | No.Transaksi <b class="text-success"><?php echo $por['code']; ?></b> | Opt. <span id="font-weight-bold"><?php echo $por['name_e']; ?></span>
						<input type="hidden" id="por_id" value=<?php echo encrypt_custom($por['id']); ?>>
                    </h3>
                </div>
				<div class="kt-portlet__head-toolbar">
					<div class="kt-portlet__head-wrapper">
						<div class="kt-portlet__head-actions">
							...
							<button type="button" class="btn btn-outline-danger btn-elevate btn-icon" id="delete_por_btn"
								data-id="<?php echo $por['id']; ?>" data-container="body" data-toggle="kt-tooltip" data-placement="left" data-skin="dark" title="Hapus Pembayaran">
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <?php 
                                    $data = array('type' => 'text', 'class' => 'form-control font-weight-bold', 'value' => date('d-m-Y', strtotime($por['date'])), 'readonly' => 'true'); 
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <label class="col-md-3 col-form-label text-dark text-right">PELANGGAN</label>                                            
                            <div class="col-md-9">
								<?php 
                                    $data = array('type' => 'text', 'class' => 'form-control font-weight-bold', 'value' => $por_transaction[0]['customer'], 'readonly' => 'true'); 
                                    echo form_input($data);                                                                                 
								?>
                            </div>
                        </div>
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" rows="3" readonly><?php echo $por['information']; ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="kt-portlet">
            <div class="kt-portlet__body">
                ...
                <table class="table table-sm table-bordered table-hover" id="datatable_transaction">
                    ...
                    <tbody>
                        <?php $no=1; foreach($por_transaction AS $info_por_transaction): ?>
                        <tr>
                            <td class="text-dark"><?php echo $no; ?></td>
                            <td class="text-dark text-center"><?php echo $info_por_transaction['date']; ?></td>
                            <td class="text-dark text-left"><?php echo $info_por_transaction['code_si']; ?></td>									
                            <td class="text-dark text-right"><?php echo $info_por_transaction['disc_rp']; ?></td>
                            <td class="text-primary text-right"><?php echo $info_por_transaction['amount']; ?></td>
                        </tr>
                        <?php $no++; endforeach; ?>
                        <tr>
                            <td colspan="4" class="text-right">BIAYA LAINNYA</td>
                            <td class="text-primary text-right"><?php echo $por['cost']; ?></td>
                        </tr>
                    </tbody>                            
                </table>                
            </div>
        ...
        <div class="kt-portlet">
            <div class="kt-portlet__body">
                ...
                <table class="table table-sm table-bordered table-hover" id="datatable_payment">
                    ...
                    <tbody>
                        <?php foreach($por_detail AS $info_por_detail): ?>
                        <tr>		
                            <td class="text-center"><?php echo $info_por_detail['method']; ?></td>
                            <td class="text-center"><?php echo $info_por_detail['account_id']; ?></td>
                            <td class="text-center"><?php echo $info_por_detail['cheque_number']; ?></td>
                            <td class="text-center"><?php echo $info_por_detail['cheque_open_date']; ?></td>                                    
                            <td class="text-center">
                                <?php echo $info_por_detail['cheque_close_date']; ?>
                                <?php if($info_por_detail['method'] == "CEK/GIRO" && $info_por_detail['cheque_status'] == 2): ?>
                                    <span class="kt-font-bold text-warning cheque_acquittance_btn" data-toggle="modal" data-target="#cheque_acquittance_modal" data-id="<?php echo $info_por_detail['id']; ?>" data-chequenumbertitle="<?php echo $info_por_detail['cheque_number']; ?>"
                            ...
                            <td class="text-center"><?php echo $info_por_detail['cheque_acquittance_date']; ?></td>
                            <td class="text-primary text-right"><?php echo $info_por_detail['amount']; ?></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>                						                
            ...
            <div class="kt-portlet__body">
                <div class="form-group row">
                    <div class="col-md-6">
                        ...
                        <?php
                            $data = array('type' => 'text', 'class' => 'form-control text-right', 'value' => number_format($por['grandtotal']-$por['cost'], 2, '.' , ','), 'readonly' => 'true'); 
                            echo form_input($data);
                            ?>
                    </div>
                    <div class="col-md-6">
