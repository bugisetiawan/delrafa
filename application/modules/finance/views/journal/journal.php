                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <a href="<?php echo site_url('coa_account'); ?>" class="btn btn-square btn-warning btn-elevate btn-elevate-air">
                                <i class="la la-file"></i>
                                <span class="d-none d-sm-inline">Daftar COA</span>
                            </a>
                            <?php endif; ?>
                            <a href="<?php echo site_url('journal/create'); ?>" class="btn btn-square btn-success btn-elevate btn-elevate-air">
                                <i class="la la-plus"></i>
                                <span class="d-none d-sm-inline">Jurnal Baru</span>
                            </a>
                        </div>
                    </div>
                </div>
