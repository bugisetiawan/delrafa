        ...
        <div class="modal-dialog modal-lg" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <input type="hidden" id="deposit_type" name="deposit_type" value="1">
                    <input type="hidden" id="to_cl_type" name="to_cl_type" value="3">
                    <div class="form-group row">                                                
                        ...
                        <div class="col-md-6">
                            <label class="text-dark"><span class="text-danger">*</span>Supplier</label>
                            <div>
