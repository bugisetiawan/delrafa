                        ...
                        <div class="kt-portlet kt-portlet--mobile">
							...
							<div class="kt-portlet__body">
								...
								<div class="form-group row">
									...
									<div class="col-md-10">
										<?php 
											$data = array('type' => 'text', 'class' => 'form-control', 'value' => $user['code_e'].' | '.$user['code_u'].' | '.$user['name_e'], 'readonly' => 'true'); 
											echo form_input($data);
										?>
									</div>										
								</div>
								<div class="form-group row">
									...
									<div class="col-md-3">
										<input type="text" class="form-control text-center time" name="start_time" value="<?php echo $user['start_time']; ?>">
									</div>
									<label class="col-md-2 col-form-label text-dark text-center">HINGGA</label>
									<div class="col-md-3">
										<input type="text" class="form-control text-center time" name="end_time" value="<?php echo $user['end_time']; ?>">
									</div>
								</div>
								<div class="form-group row">
									<div class="col-md-2">
										<label class="col-form-label text-dark">PASSWORD BARU</label>
									</div>								
									<div class="col-md-10">
											...
											<tbody>
												...
												<tr>
													...
													<td class="text-center">
														...
														<input type="checkbox" class="check-module <?php echo 'module-'.$info['id']; ?>" data-module-id="<?php echo $info['id']; ?>" name="A-<?php echo $info['id']; ?>" value="1" <?php if(in_array("A", json_decode($info['access_method']))) { echo 'checked';} ?>>&nbsp;<span></span>
														</label>
														<?php endif; ?>
													</td>														
													<td class="text-center">
														...
														<label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand" >
														<input type="checkbox" class="check-module <?php echo 'module-'.$info['id']; ?>" data-module-id="<?php echo $info['id']; ?>" name="C-<?php echo $info['id']; ?>" value="1" <?php if(in_array("C", json_decode($info['access_method']))) { echo 'checked';} ?>>&nbsp;<span></span>
														</label>
														<?php endif; ?>
													</td>
													<td class="text-center">
														...
														<label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand" >
														<input type="checkbox" class="check-module <?php echo 'module-'.$info['id']; ?>" data-module-id="<?php echo $info['id']; ?>" name="R-<?php echo $info['id']; ?>" value="1" <?php if(in_array("R", json_decode($info['access_method']))) { echo 'checked';} ?>>&nbsp;<span></span>
														</label>
														<?php endif; ?>
													</td>
													<td class="text-center">
														...
														<label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand" >
														<input type="checkbox" class="check-module <?php echo 'module-'.$info['id']; ?>" data-module-id="<?php echo $info['id']; ?>" name="U-<?php echo $info['id']; ?>" value="1" <?php if(in_array("U", json_decode($info['access_method']))) { echo 'checked';} ?>>&nbsp;<span></span>
														</label>
														<?php endif; ?>
													</td>
													<td class="text-center">
														...
														<label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand" >
														<input type="checkbox" class="check-module <?php echo 'module-'.$info['id']; ?>" data-module-id="<?php echo $info['id']; ?>" name="D-<?php echo $info['id']; ?>" value="1" <?php if(in_array("D", json_decode($info['access_method']))) { echo 'checked';} ?>>&nbsp;<span></span>
														</label>
														<?php endif; ?>
													</td>
													<td class="text-center">														
							...
							<div class="kt-portlet__foot">
								<div class="kt-form__actions">
									<div class="row">
										<div class="col-md-6">
											<a href="<?php echo base_url('setting'); ?>" class="btn btn-danger btn-brand btn-elevate-hover btn-square form-control"><i class="fa fa-times"></i>BATAL</a>
										</div>
										<div class="col-md-6">                                
