    ...
    <body>
		<?php foreach($sot AS $info_sot): ?>
			<table style="width:100%;">
				<tbody>
					<tr>
						<td class="text-left">MUTASI | <?php echo date('d-m-Y H:i:s'); ?></b></th>
					</tr>
					<tr>
						<td class="text-left"><?php echo $mutation['code'].' | '.$mutation['name_c']; ?></b></th>
					</tr>
				</tbody>
			</table>
			<table style="width:100%;">
				<tbody>
					<tr>
						<td style="font-size:22px;"><?php echo $info_sot['code_fw'].'->'.$info_sot['code_tw']; ?></td>
					</tr>
					<tr><td><br></td></tr>
				</tbody>
			</table>						
			...
			<table style="width:100%;" id="product_table">
				...
				<tbody>
					...
					<tr>
						<td valign="top" colspan="2" class="text-right">= <?php echo $info_product['qty'].' '.$info_product['code_u']; ?></td>
					</tr>
					<?php $no++; endforeach; ?>
				</tbody>
			</table>
