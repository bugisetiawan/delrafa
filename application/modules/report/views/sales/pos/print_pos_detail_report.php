...
<html lang="en">
    ...
    <body>
        <table style="width: 100%;" celpadding="1">
            ...
            <tr>
                    <td width="25%">Tanggal : <b><?php echo date('d-m-Y', strtotime($info['pos']['date'])); ?></b></td>
                    <td width="25%">Jam : <b><?php echo date('H:i:s', strtotime($info['pos']['time'])); ?></b></td>
                    <td width="30%">No. Transaksi : <b><?php echo $info['pos']['invoice']; ?></b></td>                    
                    <?php 
                        if($info['pos']['ppn'] == 0)
                        {
                            $ppn = "NON";
                        }
                        elseif($info['pos']['ppn'] == 1)
                        {
                            $ppn = "PPN";
                        }
                        else
                ...
                <tr>
                    <td>Customer</b></td> 
                    <td  colspan="3">: <b><?php echo $info['pos']['name_c']; ?></td>
                </tr>     
                <tr>
                    <td>&nbsp;</td>
                </tr>                      
                <tr>
                    <td colspan="4" style="border-bottom: 1px solid black;">
                        <table style="width: 100%;" cellpadding="1">
                            ...
                            <tbody>
                            <?php $subtotal=0; $no=1; foreach($info['detail_pos'] AS $info2): ?>                                                    
                                <tr>
                                ...
                                <tr>
                                    <td  colspan="7" class="text-right">TOTAL AKHIR:</td>
                                    <td class="text-right">&nbsp;<?php echo number_format($info['pos']['grandtotal'],2,".",","); ?></td>
                                    <?php $grandtotal = $grandtotal + $info['pos']['grandtotal']; ?>
                                </tr>
                            </tbody>                                            
                        </table> 
                    </td>
