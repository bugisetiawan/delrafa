        ...
        <div class="kt-portlet kt-portlet--mobile" id="filter_portlet">
                        ...
                        <div class="kt-portlet__head-actions">
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item text-dark" href="javascript:void(0);" id="print_sales_return_report">- Cetak Laporan Daftar Retur Penjualan</a>
                                    <a class="dropdown-item text-dark" href="javascript:void(0);" id="print_sales_return_detail_report">- Cetak Laporan Detail Retur Penjualan</a>
                                    <a class="dropdown-item text-dark" href="javascript:void(0);" id="print_sales_return_daily_report">- Cetak Laporan Retur Penjualan Harian</a>
                                </div>
                            </div>
            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">                    
                    <div class="col-md-3">
                        <label class="text-dark">PERIODE RETUR PENJUALAN</label>
