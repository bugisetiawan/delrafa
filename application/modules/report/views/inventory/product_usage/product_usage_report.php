        ...
        <div class="kt-portlet kt-portlet--mobile">
                        ...
                        <div class="kt-portlet__head-actions">   
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu">                                    
                                    <a class="dropdown-item text-dark" href="javascript:void(0);" id="print_product_usage_detail_report">- Cetak Laporan Detail Pemakaian</a>
                                </div>
                            </div>                        
                            <a href="javascript: void(0);" onclick="$('#datatable').DataTable().ajax.reload(); total_product_usage();" class="btn btn-square btn-brand btn-elevate btn-elevate-air">
            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label class="col-form-label kt-font-dark">PERIODE PEMAKAIAN</label>
                        ...
                        <div class="col-md-6">
                            <label class="col-form-label kt-font-dark">USER</label>
                            <select class="form-control kt-font-dark" name="user_code" id="user_code">
                            </select>  
                        </div>
                    </div>
                </div>
