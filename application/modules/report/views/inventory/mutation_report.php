        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label class="col-form-label text-dark">PERIODE MUTASI</label>
                        ...
                        <div class="col-md-3">
                            <label class="col-form-label text-dark">GUDANG ASAL</label>
                            <select class="form-control text-dark" id="from_warehouse_id">
                            </select>  
                        </div> 
                        <div class="col-md-3">
                            <label class="col-form-label text-dark">GUDAN TUJUAN</label>
                            <select class="form-control text-dark" id="to_warehouse_id">>
                            </select>  
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" id="search_product" placeholder="Silahkan isi nama produk untuk melakukan pencarian...">
