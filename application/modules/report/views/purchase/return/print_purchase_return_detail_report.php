    ...
    <body>
        <table style="width: 100%;" cellpadding="1">
            ...
            <?php $total_return = 0; foreach($data AS $info): ?>                                                                
                <tr>
                    <td width="25%">Tanggal : <b><?php echo date('d-m-Y', strtotime($info['purchase_return']['date'])); ?></b></td>                                            
                    <td>No. Transaksi : <b><?php echo $info['purchase_return']['code']; ?></b></td>
                </tr>       
                <tr>
                    <td>Supplier</b></td> 
                    <td>: <b><?php echo $info['purchase_return']['name_s']; ?></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>                      
                <tr>
                    <td colspan="2" style="border-bottom: 1px solid black;">
                        <table style="width: 100%;" cellpadding="1">
                            ...
                            <tbody>
                            <?php $subtotal=0; $no=1; foreach($info['detail_purchase_return'] AS $info2): ?>                                                    
                                <tr>
                                ...
                                <tr>                                    
                                    ...
                                    <td class="text-right">&nbsp;<?php echo number_format($info['purchase_return']['total_return'],2,".",","); ?></td>
                                    <?php $total_return = $total_return + $info['purchase_return']['total_return']; ?>
                                </tr>
                            </tbody>                                            
                        </table> 
                    </td>
