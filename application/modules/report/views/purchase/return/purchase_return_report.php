        ...
        <div class="kt-portlet kt-portlet--mobile" id="filter_portlet">
                        ...
                        <div class="kt-portlet__head-actions">
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item text-dark" href="javascript:void(0);" id="print_purchase_return_report">- Cetak Laporan Daftar Retur Pembelian</a>
                                    <a class="dropdown-item text-dark" href="javascript:void(0);" id="print_purchase_return_detail_report">- Cetak Laporan Detail Retur Pembelian</a>
                                    <a class="dropdown-item text-dark" href="javascript:void(0);" id="print_purchase_return_daily_report">- Cetak Laporan Retur Pembelian Harian</a>
                                </div>
                            </div>
            ...
            <?php echo form_open_multipart('', ['id' => 'filter_form', 'autocomplete'=>'off']); ?>
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label class="text-dark">PERIODE RETUR PEMBELIAN</label>
