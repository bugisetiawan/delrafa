        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <label class="text-dark text-right">SUB DEPARTEMEN</label>
                ...
                <div class="form-group row">
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="search" id="search" placeholder="Silahkan Kode/Nama Produk untuk melakukan pencarian..." autocomplete="off">
                        </div>
