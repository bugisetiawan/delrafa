        ...
        <table style="width: 100%;" celpadding="1" cellspacing="1">
            <thead>
                <tr>
                    ...
                    <th style="border-bottom: 1px solid black;">No. Refrensi</th>
            ...
            <tbody>        
                <?php $no=1; $total_grandtotal=0; foreach($data As $purchase_invoice): ?>
                    <tr>
                        ...
                        <td><?php  echo $purchase_invoice['code']; ?></td>
                        <td><?php  echo $purchase_invoice['invoice']; ?></td>                        
                        <td><?php  echo $purchase_invoice['supplier']; ?></td>
                        <?php 
                ...
                <?php $no++; endforeach; ?>
                    <tr>
                        <td style="border-top: 1px solid black;" colspan="5">&nbsp;TOTAL</td>
