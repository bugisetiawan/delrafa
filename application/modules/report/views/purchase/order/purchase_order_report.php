                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">                           
                            <a href="javascript: void(0);" onclick="$('#purchase_order_datatable').DataTable().ajax.reload();" class="btn btn-square btn-brand btn-elevate btn-elevate-air">
                ...
                <div class="row">                    
                    <div class="col-md-3">
                        <div class="form-group">
                            <label class="kt-font-dark">PERIODE PEMESANAN PEMBELIAN</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="kt-font-dark">SUPPLIER</label>
        ...
        <div class="kt-portlet kt-portlet--mobile">            
            <div class="kt-portlet__body">
                <div class="row">
                    <div class="col-md-12">	
                        <!--begin: Datatable -->
                        <table class="table table-bordered table-hover" id="purchase_order_datatable">
                            <thead>
                                <tr>
