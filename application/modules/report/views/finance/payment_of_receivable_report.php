                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control kt-font-dark" name="customer_code" id="customer_code">                                    
                            </select>  
                        </div>
                        <div class="col-md-4">
                            <label class="text-dark">JENIS PEMBAYARAN</label>
                            <div class="row">
                                <div class="col-form-label col-12">
                                    <div class="kt-checkbox-inline">
                                        <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand text-dark">
                                            <input type="checkbox" class="method" name="method[]" value="1"> TUNAI
                                            <span></span>
                                        </label>
                                        <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand text-dark">
                                            <input type="checkbox" class="method"name="method[]" value="2"> TRANSFER
                                            <span></span>
                                        </label>
                                        <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand text-dark">
                                            <input type="checkbox" class="method" name="method[]" value="3"> CEK/GIRO
                                            <span></span>
                                        </label>
                                        <label class="kt-checkbox kt-checkbox--bold kt-checkbox--brand text-dark">
                                            <input type="checkbox" class="method" name="method[]" value="4">DEPOSIT
                                            <span></span>
                                        </label>
                                    </div>
                                </div>
