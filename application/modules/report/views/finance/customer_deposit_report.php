                        ...
                        <div class="kt-portlet__head-actions">
                            <!-- <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item text-dark" href="javascript:void(0);" id="print_cash_report">-Cetak Laporan Kas</a>                                    
                                </div>
                            </div> -->
                            <a href="javascript: void(0);" onclick="$('#datatable').DataTable().ajax.reload(); total_customer_deposit();" class="btn btn-square btn-brand btn-elevate btn-elevate-air">
