        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <div class="form-group row">                
                    <div class="col-md-3">
                        <label class="text-dark">PERIODE PENGELUARAN</label>
                    ...
                    <div class="col-md-3">
                        <label class="text-dark">JENIS BIAYA</label>
                        <select class="form-control text-dark" name="cost_id" id="cost_id">
                        </select>  
                    </div>
                    <div class="col-md-3">
                        <label class="text-dark">KARYAWAN</label>
                        <select class="form-control text-dark" name="employee_code" id="employee_code">                                    
                        </select>  
                    </div>                    
                </div>
