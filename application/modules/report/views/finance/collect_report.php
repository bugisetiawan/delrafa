        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-3">
                            <label class="col-form-label text-dark">PERIODE COLLECT</label>
                        ...
                        <div class="col-md-3">
                            <label class="col-form-label text-dark">COLLECTOR</label>
                            <select class="form-control text-dark" name="collector_code" id="collector_code">
                            </select>  
                        </div> 
                        <div class="col-md-3">
                            <label class="col-form-label text-dark">KASIR</label>
