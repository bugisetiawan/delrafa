        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <div class="form-group row">
                    <div class="col-md-3">
                        <label class="text-dark">PERIODE REPACKING</label>
                    ...
                    <!-- <div class="col-md-3">
                        <label class="col-form-label kt-font-dark">REPACKER</label>
                        <select class="form-control kt-font-dark" name="repacker" id="repacker">
                        </select>  
                    </div> 
                    <div class="col-md-3">
                        <label class="col-form-label kt-font-dark">OPERATOR</label>
                        <select class="form-control kt-font-dark" name="employee_code" id="employee_code">
                        </select>  
                    </div> -->                    
                </div>
            </div>            
