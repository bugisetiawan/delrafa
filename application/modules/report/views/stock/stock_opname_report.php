        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <div class="form-group row">
                    <div class="col-md-3">
                        <label class="text-dark">PERIODE STOCK OPNAME</label>
                    ...
                    <div class="col-md-3">
                        <label class="text-dark">STATUS STOCK OPNAME</label>
                        <select class="form-control kt-font-dark" name="status" id="status">
