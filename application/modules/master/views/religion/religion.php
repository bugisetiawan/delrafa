<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <!--begin::Form-->
                <?php echo form_open('master/religion/add', array('class' => 'form-horizontal kt-form', 'id' => 'create_data', 'autocomplete' => 'off')); ?>             
                    <div class="row">                        
                        <div class="col-md-10">
                            <div class="form-group row">
                                <label class="col-md-1 col-form-label kt-font-dark"><b>NAMA</b></label>   
                                <div class="col-md-11">
                                    <?php 
                                        $data = array('type' => 'text', 'class' => 'form-control', 'placeholder' => 'Isikan Nama Agama', 'id' => 'name', 'name' => 'name', 'value' => set_value('name'), 'autofocus' => 'true'); 
    ...
    <div class="modal fade" id="update_form">
        ...
        <?php echo form_open('master/religion/update', array('class' => 'form-horizontal kt-form kt-form--label-right', 'id' => 'update_data', 'autocomplete' => 'off')); ?>
