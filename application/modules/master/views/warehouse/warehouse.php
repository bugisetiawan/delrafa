<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        ...
        <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            <button class="btn btn-square btn-warning btn-elevate btn-elevate-air" id="default_warehouse" data-toggle="modal" data-target="#default_warehouse_form">
                                <i class="la la-align-justify"></i>
                                <span class="d-none d-sm-inline"> Pengaturan Gudang</span>
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="kt-portlet__body">               
                <!--begin::Form-->
                <?php echo form_open('master/warehouse/add', array('class' => 'form-horizontal kt-form', 'id' => 'create_data', 'autocomplete' => 'off')); ?>             
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <?php 
                                        $data = array('type' => 'text', 'class' => 'form-control', 'placeholder' => 'Isikan Kode Gudang', 'id' => 'code', 'name' => 'code', 'value' => set_value('code'), 'autofocus' => 'true'); 
                        ...
                        <div class="col-md-5">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <?php 
                                        $data = array('type' => 'text', 'class' => 'form-control', 'placeholder' => 'Isikan Nama Gudang', 'id' => 'name', 'name' => 'name', 'value' => set_value('name')); 
                                        echo form_input($data);                                             
                                    ?>
                                </div>
                            </div>
    ...
    <!-- end:: Content -->
    <!--begin::Default Warehouse Modal-->
    <div class="modal fade" id="default_warehouse_form">
        <div class="modal-dialog modal-lg" role="document">
            <?php echo form_open('master/Warehouse/default', ['id'=> 'default_warehouse_data', 'class' => 'kt-form', 'autocomplete' => 'off']); ?>
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Pengaturan Gudang</h5>
                </div>
    ...
    <!--end::Default Warehouse Modal-->
    <!--begin::Update Modal-->
    <div class="modal fade" id="update_form">
        <div class="modal-dialog modal-lg">
        <?php echo form_open('master/warehouse/update', array('class' => 'form-horizontal kt-form kt-form--label-right', 'id' => 'update_data', 'autocomplete' => 'off')); ?>
                <div class="modal-content">
                    <div class="modal-header">
