<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            <h3 class="kt-subheader__title">Master <?php echo $title; ?></h3>
        </div>
    </div>
    <!-- end:: Content Head -->    
    <!-- begin:: Content -->
    <div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                <!--begin::Form-->
                <?php echo form_open('master/status/add', array('class' => 'form-horizontal kt-form', 'id' => 'create_data', 'autocomplete' => 'off')); ?>             
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <?php 
                                        $data = array('type' => 'text', 'class' => 'form-control', 'placeholder' => 'Isikan Kode Status', 'id' => 'code', 'name' => 'code', 'value' => set_value('code'), 'autofocus' => 'true'); 
                        ...
                        <div class="col-md-5">
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <?php 
                                        $data = array('type' => 'text', 'class' => 'form-control', 'placeholder' => 'Isikan Nama Status', 'id' => 'name', 'name' => 'name', 'value' => set_value('name')); 
                                        echo form_input($data);                                             
                                    ?>
                                </div>
                            </div>
    ...
    <div class="modal fade" id="update_form">
        ...
        <?php echo form_open('master/status/update', array('class' => 'form-horizontal kt-form kt-form--label-right', 'id' => 'update_data', 'autocomplete' => 'off')); ?>
