            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        ...
                        <small class="kt-font-bold kt-font-dark">*Download format import master produk <a href="">disini</a></small>
                    </div>                    
                </div>
                <div class="row">
                            ...
                            <tbody>                                 
                                <?php $error=0; $no=0; foreach($sheet AS $info): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center kt-font-dark"><?php echo $info[2]; ?></td>
                                        <td class="text-center kt-font-dark"><?php echo $info[3]; ?></td>
                                        <td class="text-center kt-font-dark"><?php echo $info[4]; ?></td>
                                        <td class="text-center kt-font-dark"><?php echo $info[5]; ?></td>
                                        <td class="text-center kt-font-dark"><?php echo $info[6]; ?></td>
                                        <td class="text-center kt-font-dark"><?php echo $info[7]; ?></td>
                                    </tr>
                                    <?php endif; ?>
                                <?php $no++; endforeach; ?>
                            </tbody>
