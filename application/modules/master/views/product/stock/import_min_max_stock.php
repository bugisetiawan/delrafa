            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        ...
                        <small class="kt-font-bold kt-font-dark">*Belum Memiliki File Import? Silahkan <a class="text-primary" href="<?php echo site_url('product/export/min_max_stock'); ?>">klik disini</a></small>
                    </div>                    
                </div>
                <div class="row">
        ...
        <div class="kt-portlet kt-portlet--mobile">            
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                        Preview  Stok Minimal dan Maksimal
                    </h3>
                </div>
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        ...
                        <table class="table table-bordered table-hover table-checkable" id="datatable">
                            <thead>
                                <tr style="text-align:center;">
                                    ...
                                    <th class="text-dark">STOK MINIMAL</th>
                                    <th class="text-dark">STOK MAKSIMAL</th>                                    
                                </tr>
                            </thead>
                            <tbody>                                 
                                <?php $error=0; $no=0; foreach($sheet AS $info): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center kt-font-dark"><?php echo ($info[4] != "") ? $info[4] : 0; ?></td>
                                        <td class="text-center kt-font-dark"><?php echo ($info[5] != "") ? $info[5] : 0; ?></td>
                                    </tr>
                                    <?php endif; ?>
                                <?php $no++; endforeach; ?>
                            </tbody>
