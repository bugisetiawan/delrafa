...
class Education extends System_Controller 
{	
    ...
    {
		$header = array("title" => "Pendidikan");
		$footer = array("script" => ['master/education.js']);
    ...
    {        
		if($this->system->check->access('delete'))
		{
	...
	{
		$data       = $this->crud->get('education')->result();
		if($data)
		{
			$response   = [
				'status'    => [
