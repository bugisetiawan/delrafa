...
class Position extends System_Controller 
{	
    ...
    {
        if($this->system->check_access('position', 'A'))
		{
            $header = array("title" => "Jabatan");
            $footer = array("script" => ['master/position.js']);
	...
	public function add()
    {
        if($this->system->check_access('position', 'C'))
        {
            $post   = $this->input->post();
    ...
    {
        if($this->system->check_access('position', 'U'))
        {
            $post = $this->input->post();
    ...
    {        
        if($this->system->check_access('position', 'D'))
        {
    ...
    public function get_position()
    {
        ...
        $data       = $this->crud->get_where($this->table, $where)->result();
        if($data)
        {
            $response   = [
                'status'    => [
