$(document).ready(function() {	
	...
	var table = $("#datatable").DataTable({
		...
		ajax: {
			"url": "finance/Cash_ledger/small_cash", 
			"type": "POST"
		},
		columns: [
			...
			{"data": "method", className:'text-dark text-center', width: "100px"},
			{"data": "balance", className:'text-dark text-right'},
		...
		columnDefs: [
			...
			{ 
                ...
                render : function(val){                    
					if(val == 1)
					{
						return '<span class="text-success"><b>DEBIT</b></span>';
					}
					else
					{
						return '<span class="text-danger"><b>KREDIT</b></span>';
					}
                }
			},
			{ 
                ...
                render : function(val){                    
					if(Number(val) >= 0)
					{
						return '<span class="text-success"><b>'+format_number(val)+'</b></span>';
					}
					else
					{
						return '<span class="text-danger"><b>('+format_number(val)+')</b></span>';
					}
                }
			}
        ],
