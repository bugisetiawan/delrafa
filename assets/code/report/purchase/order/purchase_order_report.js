...
$(document).ready(function(){
	...
	var table = $("#purchase_order_datatable").DataTable({
		processing: true,
		responsive: true,
		language: {            
		...
		ajax: {
			"url"		: "report/Purchase_report/purchase_order/", 
			"type"		: "POST",			
            "data":function(data){
	...
	$.getJSON("report/Purchase_report/get_supplier_purchase_order_report", (data) => {
	...
	$('#from_date, #to_date, #supplier_code').change(function(){		
		get_total_purchase_order_report();
		table.ajax.reload();
	});
...
function get_total_purchase_order_report()
{
	$.ajax({
		type: "POST",
		url: "report/Purchase_report/get_total_purchase_order_report/",		
		dataType: "JSON",
		data: {
