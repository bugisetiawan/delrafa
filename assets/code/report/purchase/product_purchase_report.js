...
$(document).ready(function(){
	...
	var table = $("#datatable").DataTable({
		...
		ajax: {
			"url"		: "report/Purchase_report/product_purchase/", 
			"type"		: "POST",
			"data":function(data){
		...
		columns: [
			...
			{"data": "total_stock", className: 'text-dark text-right', width: "50px", orderable:false},
			{"data": "unit", className: 'text-dark text-left', width: "50px", orderable:false},			
			{"data": "total_purchase", className: 'text-primary text-right', width: "100px", orderable:false, render: $.fn.dataTable.render.number(',', '.', 0)},
			{"data": "average_purchase", className: 'text-dark text-right', width: "150px", orderable:false, render: $.fn.dataTable.render.number(',', '.', 0)}
		],
		columnDefs: [
            { 
				targets: 4,
	...
	$('#from_date, #to_date, #department_code, #subdepartment_code, #supplier_code, #ppn').change(function(){
		get_total_product_purchase_report();
		table.ajax.reload();
	});
...
function get_total_product_purchase_report()
{
	$.ajax({
		type: "POST",
		url: "report/Purchase_report/get_total_product_purchase_report/",		
		dataType: "JSON",
		data: {
