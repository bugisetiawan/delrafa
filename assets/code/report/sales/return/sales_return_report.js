...
$(document).ready(function(){
	...
	var table = $("#datatable").DataTable({		
		...
		ajax: {
			"url": "report/Sales_report/sales_return/", 
			"type": "POST",
			"data":function(data){
	...
	$('#from_date, #to_date, #customer_code').change(function(){
		table.ajax.reload();
		get_total_sales_return_report();
	});

	get_total_sales_return_report();

	$('#print_sales_return_report').click(function(){		
		$('#filter_form').attr('target', '_blank').attr('action', 'report/Sales_report/print_sales_return_report').submit();
	});

	$('#print_sales_return_daily_report').click(function(){
		$('#filter_form').attr('target', '_blank').attr('action', 'report/Sales_report/print_sales_return_daily_report').submit();
	});

	$('#print_sales_return_detail_report').click(function(){		
		$('#filter_form').attr('target', '_blank').attr('action', 'report/Sales_report/print_sales_return_detail_report').submit();
	});
});

function get_total_sales_return_report()
{
	$.ajax({
		type: "POST",
		url: "report/Sales_report/get_total_sales_return_report/",		
		dataType: "JSON",
		data: {
