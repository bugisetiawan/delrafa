...
$(document).ready(function(){
	...
	var table = $("#datatable").DataTable({
		...
		ajax: {
			"url"		: "report/Sales_report/product_sales_return/", 
			"type"		: "POST",
			"data":function(data){				
		...
		columns: [				
			...
			{"data": "total_qty", className: 'text-dark text-center', width: "50px", orderable:false},
			{"data": "unit", className: 'text-dark text-center', width: "50px", orderable:false},			
			{"data": "total_sales_return", className: 'text-primary text-right', width: "100px", orderable:false, render: $.fn.dataTable.render.number(',', '.', 0)},
			{"data": "average_sales_return", className: 'text-dark text-right', width: "150px", orderable:false, render: $.fn.dataTable.render.number(',', '.', 0)}						
		],
		order: [[1, 'asc']],
	...
	$('#from_date, #to_date, #department_code, #subdepartment_code').change(function(){
		get_total_product_sales_return_report();
		table.ajax.reload();
	});
...
function get_total_product_sales_return_report()
{
	$.ajax({
		type: "POST",
		url: "report/Sales_report/get_total_product_sales_return_report/",		
		dataType: "JSON",
		data: {			
