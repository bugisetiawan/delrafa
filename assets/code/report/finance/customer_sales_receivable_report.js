...
$(document).ready(function(){
	...
	$('#from_date, #to_date, #customer_code, #sales_code, #zone_id').change(function(){
		total_customer_sales_receivable();
		table.ajax.reload();
	});
	...
	var table = $("#datatable").DataTable({
		...
		ajax: {
			"url"		: "report/Finance_report/customer_sales_receivable/", 
			"type"		: "POST",			
            "data":function(data){                
...
function total_customer_sales_receivable()
{
	$.ajax({
		type: "POST",
		url: "report/Finance_report/total_customer_sales_receivable/",		
		dataType: "JSON",
		data: {
