...
$(document).ready(function() {
	...
	$('#print_bank_report').click(function(){		
		if($('#cl_type').val() != "" && $('#account_id').val() != "")
		{
			$('#filter_form').attr('target', '_blank').attr('action', 'report/Finance_report/print_bank_report').submit();
		}
		else
		{
			swal.fire(
	...
	var table = $("#datatable").DataTable({
		...
		ajax: {
			"url": "report/Finance_report/bank", 
			"type": "POST",
			"data":function(data){
...
function total_bank()
{
	$.ajax({
		type: "POST",
		url: "report/Finance_report/total_bank/",
		dataType: "JSON",
		data: {
