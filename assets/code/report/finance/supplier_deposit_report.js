...
$(document).ready(function() {	
	...
	$.getJSON("finance/Cash_ledger/get_cash_ledger_account/3", (data) => {
	...
	var table = $("#datatable").DataTable({
		...
		ajax: {
			"url": "report/Finance_report/supplier_deposit", 
			"type": "POST",
			"data":function(data){
	...
	$('#from_date, #to_date').on('change', function(){
		...
		total_supplier_deposit(); table.ajax.reload();
	});
...
function total_supplier_deposit()
{
	$.ajax({
		type: "POST",
		url: "report/Finance_report/total_supplier_deposit/",
		dataType: "JSON",
		data: {
