...
$(document).ready(function(){
	...
	var table = $("#datatable").DataTable({				
		...
		ajax: {
			"url"		: "report/Finance_report/cheque_of_debt/",
			"type"		: "POST",			
            "data":function(data){
		...
		columns: [
			...
			{"data": "code_purchase", className: "text-dark text-left", width: "100px"},
	...
	$('#from_date, #to_date, .payment, #supplier_code').change(function(){
		table.ajax.reload();
	});
