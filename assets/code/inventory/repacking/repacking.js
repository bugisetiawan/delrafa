$(document).ready(function(){
	...
	var table = $("#datatable").DataTable({
		...
		ajax: {
			"url"		: "inventory/Repacking/", 
			"type"		: "POST"
		},
		columns: [				
			{"data": "id_rp", className: "text-dark text-center", width: "10px"},
			{"data": "date", className: "text-dark text-center", width: "100px"},
            {"data": "code_rp", className: "text-dark text-center", width: "100px"},
            {"data": "code_p", className: "text-dark text-center", width: "100px"},
            {"data": "name_p", className: "text-dark text-left"},
			{"data": "repacker", className: 'text-dark text-center'},
